  ...
  return (
    <figure className={`landing-dashboard-shot ${className}`}>
      <Image
        ...
        priority={priority}
        quality={90}
        sizes="(max-width: 640px) calc(100vw - 58px), (max-width: 900px) calc(100vw - 88px), (max-width: 1200px) 68vw, 900px"
        src={src}
        width={width}
      />
    </figure>
...
function Header() {
  return <header className="landing-header"><div className="landing-container landing-header-inner"><Brand /><nav aria-label="Primary navigation" className="landing-nav"><a href="#product">Product</a><a href="#features">Features</a><a href="#campaigns">Pricing</a><a href="#proof">Proof</a><a href="#footer">FAQ</a></nav><div className="landing-header-actions"><Link className="landing-button landing-button-outline landing-button-small" href="/sign-in">Log in</Link><Link className="landing-button landing-button-primary landing-button-small" href={signInHref}>Start Free <ArrowRight size={16} /></Link></div></div></header>;
}
